...
var app = express();
var recipes3 = require('../recipes3/recipes3_app');
...
/**
 * Start the recipe_server web server that will process database requests.
...
exports.start_server = function (callback) {
    try {
        ...
        app.use(cors());
        app.use(req_res_converter.add_recipes3_obj);
        app.use(req_res_converter.request_property_converter);
        app.use('/Recipes3/services', jsonParser, recipes3);
