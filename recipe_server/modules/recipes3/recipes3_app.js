...
router.post('/getCookbookById', function (req, res, next) {
    try {
        logger.debug('recipes3_app.getCookbookById() body[0] = ' + req.body[0]);
        // logger.debug('recipes3_app.getCookbookById()');
        // logger.debug('recipes3_app.getCookbookById() req.body:');
        // logger.debug(req.body);
        // logger.debug('recipes3_app.getCookbookById() req.recipes3: ' + req.recipes3);
        // logger.debug(req.recipes3);
...
router.post('/getRecipeWithHistory', function (req, res, next) {
    try {
        logger.debug('recipes3_app.getRecipeWithHistory() body[0] = ' + req.body[0]);
        ...
        if (Number.isInteger(req.body[0]) && req.body[0] > 0) {
            ...
            req.recipes3.err = new Error('Not a number: ' + req.body[0]);
            next();
        }
    } catch (err) {
        req.recipes3.err = err;
...
router.post('/findMostViewed', function (req, res, next) {
    try {
        logger.debug('recipes3_app.findMostViewed() req.body[0] = ' + req.body[0]);
...
router.post('/findAddedRecently', function (req, res, next) {
    try {
        logger.debug('recipes3_app.findAddedRecently() req.body[0] = ' + req.body[0]);
...
router.post('/deleteRecipe', function (req, res, next) {
    try {
        logger.debug('recipes3_app.deleteRecipe() req.body[0] = ' + req.body[0]);
...
router.post('/getRecipe', function (req, res, next) {
    try {
        logger.debug('recipes3_app.getRecipe() req.body[0] = ' + req.body[0]);
