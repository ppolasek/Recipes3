...
//  _createCollection(db, recipe_collection_name);
  console.log('createCollection() collectionName = ' + recipe_collection_name);

  db.createCollection(recipe_collection_name, function(err, res) {
    if (err) throw err;
//    console.log(res);
    console.log(recipe_collection_name + ' collection created');
