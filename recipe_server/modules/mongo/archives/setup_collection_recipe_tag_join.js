...
//var url = 'mongodb://localhost:27017/recipes3';
...
//  _createCollection(db, recipe_collection_name);
  console.log('createCollection() collectionName = ' + recipe_tag_join_collection_name);

  db.createCollection(recipe_tag_join_collection_name, function(err, res) {
    if (err) throw err;
//    console.log(res);
    console.log(recipe_tag_join_collection_name + ' collection created');
