...
//  _createCollection(db, recipe_collection_name);
  console.log('createCollection() collectionName = ' + cookbook_collection_name);

  db.createCollection(cookbook_collection_name, function(err, res) {
    if (err) throw err;
//    console.log(res);
    console.log(cookbook_collection_name + ' collection created');
